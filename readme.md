...
- **Request Body**: [Link to request body](./api/create-vehicle-stops)
- **Response Body**: [Link to response body](./api/create-vehicle-stops)
...
- **Response Body**: [Link to response body](./api/get-vehicle-stops)
